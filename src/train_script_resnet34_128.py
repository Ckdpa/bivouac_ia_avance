...
train_files, test_files, val_files = train_test_val_split_list(list_data_files('./process_image_output_128/'))
...
for epoch in range(1, n_epochs+1):
    ...
    with torch.no_grad():
        ...
        if val_loss < valid_loss_min:
            ...
            torch.save(model.state_dict(), './output/resnet_34__tcga.pt')
